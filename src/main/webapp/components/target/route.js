    ...
    <Fragment>
      ...
      <IndexCardItem {...form} onClick={() => setEditing(true)}>
        <Actions attributes={form}>
          ...
          />
          <DeleteAction itemName="target list" onDelete={onDelete} />
          <ReadOnly indexCardType="Target List" />
          <MetacardInteractionsDropdown>
            <ShareMetacardInteraction
              id={form.id}
              title={form.title}
...
export const Route = props => {
  ...
  if (error) {
    return (
      <RetryComponent
        message={'Issue retrieving Target Lists, would you like to retry?'}
        onRetry={refetch}
        error={error}
      />
    )
  ...
  return (
    <IndexCards>
      ...
      <AddItem
        ...
        onCreate={(...args) => {
          onCreate(...args)
          setMessage('Target List Created')
        }}
      />
      {forms
        .concat()
        ...
        .map(form => {
          return (
            <Item
              ...
              onSave={(...args) => {
                onSave(...args)
                setMessage('Target List Saved')
              }}
              onDelete={() => {
                onDelete(form)
                setMessage('Target List Deleted')
              }}
              form={form}
            />
          )
